require("babel-polyfill"); //This should go first fixes regenerator runtime

import {CRYPTOPIA_CREDENTIALS} from "../service/secret";

const Cryptopia = require('../service/cryptopiaAPI')();
const options = {
