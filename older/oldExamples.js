var TradeSatoshi = require('./oldIndex.js');
import {API_CREDENTIALS} from "../src/secret";
...
var privateClient = new TradeSatoshi(API_CREDENTIALS.KEY, API_CREDENTIALS.SECRET);

// uncomment the API you want to test.
// Be sure to check the parameters so you don't do any unwanted live trades

 //privateClient.getBalance(console.log, {Currency: "BTC"});

privateClient.getOrders(console.log, {market: "all", count:20});
